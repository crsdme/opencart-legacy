...
switch ($command) {
	...
	case 'import':
		...
		if ($path === '' || !is_file($path)) {
			fwrite(STDERR, "Usage: php system/cli/import_export.php import file.json [--dry-run]\n");
			exit(1);
		}
	...
	case 'help':
	default:
		echo "php system/cli/import_export.php template [entity|bundle] [json|csv]\n";
		echo "php system/cli/import_export.php export [entity|bundle] [json|csv]\n";
		echo "php system/cli/import_export.php import file.json [--dry-run]\n";
