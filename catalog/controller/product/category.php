...
class ControllerProductCategory extends Controller
{
  public function index()
  {
    ...
    $seo = $this->model_seo_meta->build(
      ...
      [
        ...
        'count' => $data['text_total_products'],
        'page' => $params['page'],
      ],
      'category'
    );
    ...
    $data['faq'] = $this->model_seo_faq->attach($data, 'category', $category_id, $category_info, [
  ...
  private function getCategoryThumb(array $category_info): string
  {
    ...
    return $this->model_product_helper->themeImage($category_info['image'], 'category', false);
  }
