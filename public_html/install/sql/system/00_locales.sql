...
-- Countries, zones, currencies, languages.
-- ---------------------------------------------------------
...
(1, 'Українська', 'ua', 'uk_UA.UTF-8,uk_UA,uk-ua,uk,ukrainian', 'uk-ua.png', 'ua', 1, 1),
(2, 'English', 'en', 'en-US,en_US.UTF-8,en_US,en-gb,english', 'en.png', 'en', 2, 1),
(3, 'Русский', 'ru', 'ru-RU,ru_RU.UTF-8,ru_RU,ru-ru,russian', 'ru.png', 'ru', 3, 1);
