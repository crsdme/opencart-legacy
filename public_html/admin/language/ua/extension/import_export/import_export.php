...
$_['help_product_key'] = 'Якщо немає product_id: шукати за SKU, або за model, якщо SKU порожній.';
...
$_['help_template'] = 'Порожній CSV/JSON зі схеми. Краще експорт, щоб ID були живі. JSON-бандл: виробники, групи атрибутів, атрибути, категорії, товари.';
$_['help_export'] = 'Фільтри товарів діють на products. Бандл вивантажує всі підтримувані сутності.';
$_['help_import'] = 'Спочатку превʼю. Збіг за id (product_id, category_id, …). Новий рядок — без id або 0. Товари чіпляйте через category_ids і attribute_id. Зображення вже мають бути в image/catalog.';
